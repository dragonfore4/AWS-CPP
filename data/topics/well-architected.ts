    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          text: "<strong>Well-Architected</strong> = ออกแบบ <em>workload</em> ให้ดี (technical)<br><strong>CAF</strong> = ออกแบบ <em>การย้ายสู่ cloud ทั้งองค์กร</em> (strategic) — ใช้คู่กันได้",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          text: "Trusted Advisor = automated checks (เร็ว, ต่อเนื่อง)<br>Well-Architected Tool = deep review โดยตอบคำถาม — ใช้ทั้งคู่ได้ครบทุกมุม",
        },
      ],
    },
    {
